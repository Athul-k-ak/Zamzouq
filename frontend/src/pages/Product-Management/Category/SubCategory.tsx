...
import { subCategoriesColumns } from "@/assets/json/TableColumn";
        ...
        <div className="pt-8 pb-8 px-8 animate-in fade-in duration-500">
            <div className="flex justify-between items-start mb-8">
                <div className="flex flex-col gap-1">
                    <h1 className="text-3xl font-bold text-slate-900">Sub categories</h1>
                    <p className="text-slate-500 font-medium tracking-tight">Manage and organize product sub-categories across the platform</p>
                </div>
            </div>
