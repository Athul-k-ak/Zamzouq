...
import { retailersColumns } from "@/assets/json/TableColumn";
import { Button } from "@/components/ui/button";
import { Input } from "@/components/ui/input";
import { useState } from "react";
import { Dialog, DialogContent, DialogHeader, DialogTitle, DialogTrigger } from "@/components/ui/dialog";
import { AddRetailersForm } from "@/components/usermanagement/retailers/AddRetailersForm";
import { useNavigate } from "react-router-dom";

const mockData = [
    {
        id: "R-001",
        businessName: "Al Barsha Mini Market",
        location: "Dubai",
        ordersCount: "145 Orders",
        purchasers: "Ahmed Hassan",
        status: "Active",
    },
    {
        id: "R-002",
        businessName: "Jumeirah Grocery Store",
        location: "Dubai",
        ordersCount: "145 Orders",
        purchasers: "Ahmed Hassan",
        status: "Inactive",
    ...
    {
        id: "R-001",
        businessName: "Ajman Quick Shop",
        location: "Sharjah",
        ordersCount: "145 Orders",
        purchasers: "Mohammed Ali",
        status: "Active",
    },
    {
        id: "R-002",
        businessName: "Marina Bay Provisions",
        location: "Dubai",
        ordersCount: "145 Orders",
        purchasers: "Ahmed Hassan",
        status: "Active",
...
export default function RetailersPage() {
    ...
    const handleActionClick = (row: any) => {
        navigate(`/user-management/retailers/${row.id}`);
    };

    return (
        <div className="p-8 max-w-300 mx-auto animate-in fade-in duration-500">
            <div className="flex flex-col gap-1 mb-8">
                <h1 className="text-3xl font-bold text-slate-900">Retailers</h1>
                <p className="text-slate-500">Manage retailer accounts and inventory</p>
            </div>
                    ...
                    <Dialog open={isAddModalOpen} onOpenChange={setIsAddModalOpen}>
                        ...
                        <DialogContent className="sm:max-w-100 bg-white rounded-3xl p-6 shadow-xl border-none overflow-hidden" showCloseButton={true}>
                            <DialogHeader className="mb-0">
                                <DialogTitle className="text-xl font-bold text-slate-900">Add New Retailers</DialogTitle>
                            </DialogHeader>
                            <AddRetailersForm onClose={() => setIsAddModalOpen(false)} />
                        </DialogContent>
                    </Dialog>
                </div>
            </div>
