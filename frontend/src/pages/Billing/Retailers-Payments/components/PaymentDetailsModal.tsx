            ...
            <DialogContent className="sm:max-w-[550px] p-0 overflow-hidden rounded-[24px] bg-white border-none shadow-2xl" showCloseButton={false}>
                ...
                <div className="px-8 py-4 flex items-center gap-6 text-slate-400 font-medium text-sm">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <span>Retailer: {payment.retailer}</span>
                    </div>
                </div>
                ...
                <div className="px-8 pb-10">
                    <div className="bg-[#fcfdfd] border border-slate-50 rounded-[32px] p-8 shadow-sm space-y-8">
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <span className="text-sm font-bold text-slate-900">{payment.type || "Cash"}</span>
                        </div>

                        {payment.customerMobile && (
                            <div className="flex justify-between items-center">
                                <span className="text-sm font-bold text-slate-400 uppercase tracking-widest">Customer Mobile</span>
                                <span className="text-sm font-bold text-slate-900">{payment.customerMobile}</span>
                            </div>
                        )}
                    </div>
                </div>
