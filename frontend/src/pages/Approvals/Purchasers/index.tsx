...
import { purchaserApprovalColumns } from "@/assets/json/TableColumn";
import { Input } from "@/components/ui/input";
import { useState } from "react";
import { PurchaserDetailModal } from "./PurchaserDetailModal";
...
export default function PurchaserApprovalsPage() {
    ...
    return (
        <div className="p-8 max-w-[1600px] mx-auto animate-in fade-in duration-500">
            <div className="flex flex-col gap-1 mb-8">
                <h1 className="text-3xl font-bold text-slate-900">Purchaser Approvals</h1>
            ...
            <StyledTable
                columns={purchaserApprovalColumns}
